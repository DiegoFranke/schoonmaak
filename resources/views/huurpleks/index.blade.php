...
<!-- CSS only -->
    ...
    <h1 style="color: White;">Alle camping plekken overzicht</h1>
    ...
    <table style="color: White;background-color:text-align: center;width: 50%;margin: 0 auto;" class="table">
        ...
        @foreach($huurpleks as $key => $value)
            <tr>
                <td style="padding-left: 10px;padding-right: 10px;">{{ $value->id }}</td>
                <td style="padding-left: 10px;padding-right: 10px;">{{ $value->bezet }}</td>
                <td style="padding-left: 10px;padding-right: 10px;">{{ $value->schoon }}</td>
                <td style="padding-left: 10px;padding-right: 10px;">{{ $value->description }}</td>
                <td style="padding-left: 10px;padding-right: 10px;">{{ $value->start_date }}</td>
                <td style="padding-left: 10px;padding-right: 10px;">{{ $value->end_date }}</td>
                ...
                <td>
                    ...
                    <a class="btn btn-small btn-info" href="{{ URL::to('huurpleks/' . $value->id . '/edit') }}">Edit</a>
